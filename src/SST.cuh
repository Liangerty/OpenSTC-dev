...
// Mixed parameters, their difference, used in computations
  ...
  __device__ static real Wilcox_compressibility_correction(real Mt);

  __device__ static real Zeman_compressibility_correction(real Mt, real gammaP1);
};

template<>
struct TurbMethod<SST> {
