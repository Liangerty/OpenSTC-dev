...
void data_communication(const Mesh &mesh, std::vector<Field> &field, const Parameter &parameter, integer step,
  ...
  if (parameter.get_bool("parallel")) {
    parallel_communication<mix_model,turb,with_cv>(mesh, field, step, param);
  }
}

template<MixtureModel mix_model, class turb, bool with_cv>
__global__ void inner_communication(cfd::DZone *zone, cfd::DZone *tar_zone, integer i_face, cfd::DParameter *param) {
...
template<MixtureModel mix_model, class turb, bool with_cv>
void parallel_communication(const Mesh &mesh, std::vector<Field> &field, integer step, DParameter *param) {
...
template<MixtureModel mix_model, class turb, bool with_cv>
__global__ void assign_data_received(cfd::DZone *zone, integer i_face, const real *data, cfd::DParameter *param) {
